...
// 착공전 카운트 
$sql="select * from chandj.work where (is_deleted IS NULL or is_deleted = 0) and workStatus='착공전' order by workday desc"; 						   
 try{   
    $stmh = $pdo->query($sql);             
		...
		<div class="row"> 		
			<div class="col-sm-12"> 		
				<div class="d-flex  justify-content-center align-items-center "> 				   
				  ...
				  <h6> <span id="total_work_before_su_display" class="badge bg-dark"></span> 
				  </h6>
				</div>			 
			</div>				 
		</div>			
...
$(document).ready(function(){	    	
	document.getElementById('total_work_before_su_display').textContent = '<?= $total_row ?>';
}); 
</script> 
